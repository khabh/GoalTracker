...
public interface AuthController {
    ...
    String signUpUser(@Valid UserSignUpDTO userSignUpDTO, BindingResult createUserResult, RedirectAttributes redirectAttributes, HttpServletResponse httpServletResponse);
}
